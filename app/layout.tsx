...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website', siteName: SITE.name, title: `${SITE.name} — CRM for Capital Markets`,
    description: SITE.description, url: SITE.domain,
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const orgSchema = {
    ...
    name: SITE.name, url: SITE.domain, description: SITE.description, brand: SITE.brand,
  };
  return (
